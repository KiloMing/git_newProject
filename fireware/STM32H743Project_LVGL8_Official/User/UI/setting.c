...
static void setting_create_clock_card(lv_obj_t *parent)
{
    ...
    static lv_coord_t row_dsc[] = {22, 36, LV_GRID_TEMPLATE_LAST};
...
static void setting_create_sensor_card(lv_obj_t *parent)
{
    ...
    static lv_coord_t row_dsc[] = {24, 38, 38, LV_GRID_TEMPLATE_LAST};
...
{
    static lv_coord_t col_dsc[] = {LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    static lv_coord_t row_dsc[] = {22, 34, LV_GRID_TEMPLATE_LAST};
...
{
    static lv_coord_t col_dsc[] = {LV_GRID_FR(1), 58, 54, LV_GRID_TEMPLATE_LAST};
    static lv_coord_t row_dsc[] = {22, 34, 34, LV_GRID_TEMPLATE_LAST};
